  ...
  return (
    <div className="lg:flex-1 flex-initial shrink-0 lg:shrink flex flex-col items-stretch justify-center bg-transparent p-2 md:p-4 relative overflow-hidden lg:h-full min-h-[900px] lg:min-h-0 gap-2 md:gap-4 w-full">
      ...
      <div className="main-center-grid flex-1">
        ...
        {/* 2. Camera Feed & Radar Split */}
        <div
          className="relative z-10 bg-black/60 border border-white/20 rounded-xl overflow-hidden shadow-2xl flex flex-row items-stretch ring-1 ring-white/10 backdrop-blur-sm min-h-[220px] sm:min-h-[300px] lg:min-h-0 grid-area-camera"
        ...
        >
          ...
          {/* RIGHT HALF: RADAR */}
          <div className="relative w-1/2 h-full bg-black/40">
            <RadarNavigation
              heading={heading}
