...
function PrimaryFlightDisplay({
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      ...
      setDemoT((t) =>
        Math.min(60, Math.max(14, t + (Math.random() - 0.5) * 0.05)),
      );
    }, 80);
  ...
  const pitchPx = Math.max(-90, Math.min(90, pitch)) * 3;
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex items-stretch min-h-0 px-2 py-2 gap-2">
        {/* ── LEFT: Depth tape ──────────────────────────────── */}
        <div
          className="pfd-tape flex flex-col relative shrink-0 rounded-md overflow-hidden"
          style={{ width: "50px" }}
        >
          <div
            style={{
          ...
          <div className="flex-1 relative overflow-hidden">
            ...
            <div
              ...
              style={{ top: "50%", height: "1px", background: W45 }}
            />
            {depthTicks.map((tick, i) => {
              ...
              return (
                <div
                  ...
                  style={{ top: `${tick.pct}%`, transform: "translateY(-50%)" }}
                >
                  {maj && (
                    <span
                      style={{
          ...
          {/* Depth value */}
          <div
            className="pfd-badge text-center mx-1 mb-1 py-0.5 rounded-sm"
        ...
        <div className="flex-1 flex flex-col items-center justify-center min-h-0 min-w-0">
          <div
            ...
            style={{
              boxShadow:
                "0 0 0 2px rgba(255,255,255,0.18), 0 0 24px rgba(0,0,0,0.8), inset 0 0 32px rgba(0,0,0,0.5)",
              background: "#000",
            }}
          >
            {/* ── 3D Canvas Background (Commented out per request) ── */}
            {/* <PFD3D pitch={pitch} roll={roll} heading={normalizedHdg} /> */}
            ...
            >
              ...
              <g clipPath="url(#pfd-clip)">
                <g
                  transform={`rotate(${-clampedRoll}, 100, 100) translate(0, ${pitchPx})`}
                >
                  <rect
                    x="-300"
                    y="-300"
                  ...
                  {pitchLadder.map((deg) => {
                    ...
                    const col =
                      deg > 0
                        ...
                        : "rgba(210,130,60,0.75)";
                    const tcol =
                      deg > 0 ? "rgba(140,200,255,0.9)" : "rgba(240,160,80,0.9)";
                    return (
                      <g key={deg}>
                        <line
                          x1={100 - wHalf}
        ...
        <div
          ...
          style={{
            gap: "var(--pfd-telemetry-gap)",
            width: "var(--pfd-telemetry-width)",
          }}
        >
          {[
            {
              label: "PITCH",
              val: `${pitch >= 0 ? "+" : ""}${pitch.toFixed(1)}°`,
            },
            {
              label: "ROLL",
              val: `${roll >= 0 ? "+" : ""}${roll.toFixed(1)}°`,
            },
            ...
            <div
              key={item.label}
              className="pfd-readout flex flex-col justify-center px-1.5 py-1 rounded"
              style={{ minHeight: "0" }}
            >
              <span
                style={{
                  fontSize: "var(--pfd-lbl-font-size)",
                  color: W45,
                  letterSpacing: "0.1em",
                  fontWeight: "700",
                  lineHeight: "1",
              ...
              <span
                style={{
                  fontSize: "var(--pfd-val-font-size)",
                  fontWeight: "900",
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              fontWeight: "900",
              color:
                vertSpeed > 0 ? "#86efac" : vertSpeed < 0 ? "#fca5a5" : "#fff",
            }}
          >
            <span style={{ fontSize: "7px" }}>
              {vertSpeed > 0 ? "▲" : vertSpeed < 0 ? "▼" : "●"}
            </span>
      ...
      <div className="pfd-sep-t shrink-0">
        <div className="relative mx-2 mb-2" style={{ height: "44px" }}>
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to right, rgba(8,10,14,1) 0%, transparent 14%, transparent 86%, rgba(8,10,14,1) 100%)",
            }}
          />
