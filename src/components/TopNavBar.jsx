    ...
    <div className="flex justify-between items-center bg-black border-b border-white/20 p-1.5 sm:p-2 text-white select-none">
      ...
      <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1 rounded bg-white/5">
        ...
        >
          ...
          <span
            className={`font-mono font-bold text-xs hidden md:block ${isUsbConnected ? "text-white" : signalStrength > 70 ? "text-white" : signalStrength > 30 ? "text-white/70" : "text-white/30"}`}
          >
            {isUsbConnected
              ? "USB SERIAL"
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 border-l border-white/20 pl-1.5 sm:pl-2 ml-1.5 sm:ml-2">
          {!isUsbConnected && (
            <div
              className="hidden lg:flex items-center bg-white/5 rounded border border-white/10 px-2 py-1"
          ...
          <div
            className="hidden md:flex items-center bg-white/5 rounded border border-white/10 px-2 py-1"
            title="Camera URL"
          >
      ...
      <div className="flex items-center gap-1.5 sm:gap-3 px-1.5 sm:px-4 py-1 rounded bg-white/5">
        <div className="flex flex-col items-end">
          <span className="text-[10px] text-white/50 font-bold tracking-wider hidden sm:block">
            12V SYSTEM
          </span>
          <span
        ...
        {batteryPct > 80 ? (
          ...
          <BatteryMedium className="text-white/70" size={20} />
        ) : batteryPct > 20 ? (
          <BatteryLow className="text-white/50" size={20} />
        ) : (
